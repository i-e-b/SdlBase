#include "src/gui_core/ImmediateDraw.h"
...
// TODO: this should move out to the non-core stuff
...
int main(int argc, char * argv[])
{
    ...
    while (SDL_WaitEvent(&close_event)) { // TODO: should be kicking events out to non-core
